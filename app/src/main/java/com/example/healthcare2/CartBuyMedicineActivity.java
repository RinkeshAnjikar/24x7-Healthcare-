...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    private Button dateBtn, Checkoutbtn, Backbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateBtn = findViewById(R.id.buttonBMCartDate);
        Checkoutbtn = findViewById(R.id.buttonBMCartCheckout);
        Backbtn = findViewById(R.id.buttonBMCartBack);
