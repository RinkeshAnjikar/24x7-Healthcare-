...
public class LabCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateBtn = findViewById(R.id.buttonDateCart);
        timeBtn = findViewById(R.id.buttonTimeCart);
        Checkoutbtn = findViewById(R.id.buttoncheckoutCart);
        Backbtn = findViewById(R.id.buttonbackCart);
        tvTotal = findViewById(R.id.textViewTotalCostCart);
